...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><a href="<?php echo url_for('sfJobeetAffiliate/edit?id='.$jobeet_affiliate->getId()) ?>"><?php echo $jobeet_affiliate->getId() ?></a></td>
  ...
  <a href="<?php echo url_for('sfJobeetAffiliate/new') ?>">New</a>
